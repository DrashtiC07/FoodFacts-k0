"""
Django settings for foodfacts project.
"""
...
WSGI_APPLICATION = 'foodfacts.wsgi.application'
...
LOGOUT_REDIRECT_URL = 'scanner:index'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'foodfacts.log',
        },
        'console': {
            'level': 'INFO',
